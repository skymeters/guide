...
class Toggler {
  constructor(label1, label2, stateRef, label3 = null, description = null, image = null, imageScaler = 1, onChange = null) {
    ...
    outerWrapper.style.marginBottom = "12px";
    ...
    midContainer.style.flex = "1";
    midContainer.style.textAlign = "right";
    midContainer.style.color = "white";
    midContainer.style.fontSize = "14px";
    midContainer.style.whiteSpace = "nowrap";
    midContainer.style.paddingRight = "10px";
    if (description) {
      midContainer.textContent = description;
    }
    ...
    // Compose
    outerWrapper.appendChild(leftContainer);
    outerWrapper.appendChild(midContainer);
    outerWrapper.appendChild(rightContainer);
...
function renderCategoryButtons(mode) {
  ...
  if (mode === "slayer") {
    ...
    if (mode === "experiment") {
      ...
      infoBox.className = "exp-info-box";
      ...
      container.appendChild(toggle1.getElement());
      container.appendChild(toggle2.getElement());
      container.appendChild(toggle3.getElement());

      const toggle4 = new Toggler("Metaphysical", "Transcendent", tabletype, "Supreme", "", "pink_dye.png", 0.4, updateBase_Ench);
      ...
      container.appendChild(toggle5.getElement());
      container.appendChild(toggle6.getElement());
      container.appendChild(toggle7.getElement());
      ...
      container.appendChild(toggle8.getElement());
      container.appendChild(dropdown1.getElement());
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  toggleBtn.addEventListener("click", () => {
    ...
    card.classList.toggle("blurred", isOpening);
  });
